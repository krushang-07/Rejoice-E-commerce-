...
import React, { useEffect } from "react";
import { useDispatch, useSelector } from "react-redux";
import { useNavigate } from "react-router-dom"; // For navigation to the payment page
import {
  fetchCart,
  removeFromCartAction,
  updateCartAction,
        ...
        <>
          ...
          {items.length > 0 && (
            <div className="mt-8 bg-gray-50 p-6 rounded-lg shadow-md">
              ...
              <div className="mt-6 flex justify-center">
                <button
                  className="px-8 py-3 bg-black text-white font-semibold rounded-lg hover:bg-gray-600 transition-all"
