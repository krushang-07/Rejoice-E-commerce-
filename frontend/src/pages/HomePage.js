...
const HomePage = () => {
  ...
  return (
    <div className="overflow-hidden">
      ...
      <motion.div
        style={{
          backgroundImage: "url('banner.jpeg')", // Dummy image
          backgroundSize: "cover",
          backgroundPosition: "center",
          height: "100vh",
        }}
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <motion.div
              ...
              transition={{ duration: 1 }}
            >
              <FaShippingFast className="w-12 h-12 text-blue-500 mx-auto mb-4" />
              <h3 className="text-xl font-semibold">Free Shipping</h3>
              <p className="mt-2 text-gray-600">
                Enjoy free shipping on all orders over $50.
              </p>
            ...
            <motion.div
              ...
              transition={{ duration: 1 }}
            >
              <FaShoppingCart className="w-12 h-12 text-blue-500 mx-auto mb-4" />
              <h3 className="text-xl font-semibold">Easy Shopping</h3>
              <p className="mt-2 text-gray-600">
                Browse products and complete your purchase in minutes.
              </p>
