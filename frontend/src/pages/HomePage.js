    ...
    <div className="overflow-hidden">
      ...
      >
        ...
        >
          ...
          <Link
            to="/products"
            className="bg-blue-600 hover:bg-blue-700 text-white py-3 px-8 rounded-full text-lg transition transform hover:scale-105 duration-300"
          >
            Shop Now
          </Link>
        </motion.div>
      ...
      <section className="py-12 bg-gray-100">
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 ">
            {/* Product Card */}
            <motion.div
              className="bg-white shadow-xl rounded-lg overflow-hidden transition transform hover:scale-105 duration-300 flex justify-evenly "
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
      ...
      <footer className="bg-gray-800 text-white py-6">
        <div className="container mx-auto text-center">
          <p>&copy; 2025 PickNShop. All rights reserved.</p>
          <div className="mt-4">
            <Link to="/about" className="mx-4 text-gray-400 hover:text-white">
              About
            </Link>
            <Link to="/contact" className="mx-4 text-gray-400 hover:text-white">
              Contact
            </Link>
            <Link to="/privacy" className="mx-4 text-gray-400 hover:text-white">
              Privacy Policy
            </Link>
          </div>
        </div>
